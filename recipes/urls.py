...
from .views import (ShoppingListView, SubscribesView, RecipeDetailView,
                    RecipeCreateView, FavoritesView, RecipesView, ProfileView,
                    RecipeEditView, add_subscription, remove_subscription,
                    add_favorite, remove_favorite, add_purchases,
                    remove_purchases, get_shopping_list_txt)
